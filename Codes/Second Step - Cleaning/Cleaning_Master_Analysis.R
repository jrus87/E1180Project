...
y$thousand <- y$populationTotal/1e+3
y$CrimePerThousand <- y$freq / y$thousand
y$thousand <- NULL
Seattle.Crime.Analysis <- merge(Seattle.Crime.Analysis, y, by=c("GEOID", "Month", "Crime", "populationTotal"))
...
table(is.na(Seattle.Crime.Analysis$AgeCat)) # 94 NAs
...
Seattle.Crime.Analysis$EduCat[Seattle.Crime.Analysis$Degree>=84.48] <- "Above average Graduate"
Seattle.Crime.Analysis$EduCat[Seattle.Crime.Analysis$Degree<=84.48] <- "Below average Graduate"

table(is.na(Seattle.Crime.Analysis$EduCat)) # 94 NAs
...
Seattle.Crime.Analysis$RaceCat[Seattle.Crime.Analysis$White>=73.18] <- "Above average Whites"
Seattle.Crime.Analysis$RaceCat[Seattle.Crime.Analysis$Black>=7.773] <- "Above average Blacks"
Seattle.Crime.Analysis$RaceCat[Seattle.Crime.Analysis$share_multiple_races>=6.575] <- "Above average multiple races"

table(is.na(Seattle.Crime.Analysis$RaceCat)) # 6032 NAs
