...
## Repository
This repository contains the R code for webscraping, cleaning and analyzing the data we found for marijuana producers and retailers in the state of Washington and for crime rates and policing in Colorado.
